...
export default function OurMenuPage() {
  ...
  return (
    <>
      ...
      {/* HERO SECTION */}
      <section className="ourmenu-hero">
        <div className="ourmenu-overlay">
          <h1>Our Menu</h1>
        </div>
      ...
      <section className="ourmenu-section">
        <div className="menu-items">
          <div className="menu-card">
            <img src="/PizeriaPasta.png" alt="Pasta" />
            <h3>PASTA</h3>
          </div>

          <div className="menu-card center-card">
            <img src="/menu-pizzeria.png" alt="Pizza" />
            <h3>PIZZA</h3>
          </div>
